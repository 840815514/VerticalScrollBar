...
#import "YSegmentTitleView.h"
#import "YConstMacro.h"
@interface YSegmentTitleView()
...
@implementation YSegmentTitleView
...
- (void)setSelectedIndex:(NSInteger)selectedIndex{
    ...
    selectedBtn.titleLabel.font = [UIFont systemFontOfSize:15 weight:1];
